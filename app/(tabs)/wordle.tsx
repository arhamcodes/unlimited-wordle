...
const styles = StyleSheet.create({
  outerContainer: {
    flex: 1,
    backgroundColor: '#121213', // Dark background color
  },
  container: {
    flex: 1,
    alignItems: 'center',
    paddingTop: Platform.select({ android: 0, default: Math.max(windowHeight * 0.08, 80) }),
  },
  title: {
    fontSize: Math.min(windowWidth * 0.08, 32),
    fontWeight: 'bold',
    marginBottom: Math.max(windowHeight * 0.06, 40),
    marginTop: 110, // Added margin to ensure visibility
  },
  grid: {
